...
#define_clock -period 1000 -name clk [dc::get_ports {iCLK}] -rise 10 -fall 10
#set_attribute clock_network_late_latency 1 clk
#set_attribute clock_source_early_latency 1 clk
#set_attribute clock_setup_uncertainty {100 100} clk
#set_attribute clockexternal_delay
...
#set_attribute max_fanout 3 /designs/*
