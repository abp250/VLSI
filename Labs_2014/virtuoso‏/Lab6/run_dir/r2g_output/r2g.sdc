...
#  Created by Encounter(R) RTL Compiler v12.10-s012_1 on Fri Oct 24 17:34:55 -0500 2014
...
create_clock -name "iCLK" -add -period 1.6 -waveform {0.0 0.8} [get_ports iCLK]
group_path -name C2C -from [list \
  [get_cells {oRESULT_reg[16]}]  \
  [get_cells {oRESULT_reg[15]}]  \
  [get_cells {oRESULT_reg[14]}]  \
  [get_cells {oRESULT_reg[13]}]  \
  [get_cells {oRESULT_reg[12]}]  \
  [get_cells {oRESULT_reg[11]}]  \
  [get_cells {oRESULT_reg[10]}]  \
  [get_cells {oRESULT_reg[9]}]  \
  [get_cells {oRESULT_reg[8]}]  \
  [get_cells {oRESULT_reg[7]}]  \
  [get_cells {oRESULT_reg[6]}]  \
  [get_cells {oRESULT_reg[5]}]  \
  [get_cells {oRESULT_reg[4]}]  \
  [get_cells {oRESULT_reg[3]}]  \
  [get_cells {oRESULT_reg[2]}]  \
  [get_cells {oRESULT_reg[1]}]  \
  [get_cells {oRESULT_reg[0]}]  \
  [get_cells {A0_reg[6]}]  \
  [get_cells {A1_reg[3]}]  \
  [get_cells {A1_reg[0]}]  \
  [get_cells {A0_reg[4]}]  \
...
group_path -name C2O -from [list \
  ...
  [get_cells {B0_reg[6]}]  \
  [get_cells {B0_reg[7]}] ] -to [list \
  [get_ports {oRESULT[16]}]  \
  [get_ports {oRESULT[15]}]  \
  [get_ports {oRESULT[14]}]  \
  [get_ports {oRESULT[13]}]  \
  [get_ports {oRESULT[12]}]  \
  [get_ports {oRESULT[11]}]  \
  [get_ports {oRESULT[10]}]  \
  [get_ports {oRESULT[9]}]  \
  [get_ports {oRESULT[8]}]  \
  [get_ports {oRESULT[7]}]  \
  [get_ports {oRESULT[6]}]  \
