...
# Created by Encounter(R) RTL Compiler v10.10-s209_1 on Thu Oct 02 23:50:12 -0500 2014
...
set_attribute -quiet clock_network_late_latency {0.2 0.2 0.2 0.2} /designs/ALT_MULTADD/timing/clock_domains/domain_1/clk
set_attribute -quiet clock_source_early_latency {0.2 0.2 0.2 0.2} /designs/ALT_MULTADD/timing/clock_domains/domain_1/clk
set_attribute -quiet clock_setup_uncertainty {10.0 5.0} /designs/ALT_MULTADD/timing/clock_domains/domain_1/clk
set_attribute -quiet slew {1.0 1.0 1.0 1.0} /designs/ALT_MULTADD/timing/clock_domains/domain_1/clk
