...
create_clock -name "iCLK" -add -period 0.8 -waveform {0.0 0.4} [get_ports iCLK]
create_clock -name "clk" -add -period 0.4 -waveform {0.2 0.2} [get_ports iCLK]
set_clock_transition 0.001 [get_clocks clk]
set_load -pin_load -max 0.002 [get_ports {oRESULT[16]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[15]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[14]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[13]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[12]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[11]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[10]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[9]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[8]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[7]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[6]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[5]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[4]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[3]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[2]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[1]}]
set_load -pin_load -max 0.002 [get_ports {oRESULT[0]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[8]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[9]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[10]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[11]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[12]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[13]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[14]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[15]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {oRESULT[16]}]
...
set_clock_latency -max 0.0002 [get_clocks clk]
set_clock_latency -source -min 0.0002 [get_clocks clk]
set_clock_uncertainty -setup -rise 0.01 [get_clocks clk]
set_clock_uncertainty -setup -fall 0.005 [get_clocks clk]
