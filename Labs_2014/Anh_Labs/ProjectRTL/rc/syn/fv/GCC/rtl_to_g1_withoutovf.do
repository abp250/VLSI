set log file fv/GCC/rtl_to_g1_withoutovf.log -replace
...
elaborate design -golden -root GCC -rootonly

read design -verilog -revised -lastmod -noelab \
	-unzip fv/GCC/g1.v.gz

elaborate design -revised -root GCC
...
uniquify -all -nolib
add module attribute GCC -pipeline_retime -golden
add module attribute GCC -pipeline_retime -revised
add noblack box GCC -submodules -golden
add noblack box GCC -submodules -revised
...
write hier_compare dofile fv/GCC/hier_rtl_to_g1_withoutovf.do \
...
run hier_compare fv/GCC/hier_rtl_to_g1_withoutovf.do -analyze_abort  -dynamic_hierarchy
