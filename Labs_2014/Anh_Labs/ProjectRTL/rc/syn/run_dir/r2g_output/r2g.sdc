...
#  Created by Encounter(R) RTL Compiler v10.10-s209_1 on Wed Dec 17 18:54:18 -0600 2014
...
create_clock -name "CLK" -add -period 3.2 -waveform {0.0 1.6} [get_ports CLK]
...
group_path -name C2C -from [list \
  ...
  [get_cells {CompareAll/max_reg[0]}]  \
  [get_cells {CompareAll/max_reg[1]}]  \
  [get_cells {CompareAll/max_reg[2]}]  \
  [get_cells {Compare0123/max_reg[0]}]  \
  [get_cells {Compare0123/max_reg[1]}]  \
  [get_cells {Compare23/max_reg[0]}]  \
  [get_cells {compare01/max_reg[0]}]  \
  [get_cells {Compare45/max_reg[0]}]  \
  [get_cells {Xcc_reg[1]}]  \
  [get_cells {Xcc_reg[2]}]  \
  [get_cells {Xcc_reg[3]}]  \
  [get_cells {Xcc_reg[4]}]  \
