set log file fv/ALT_MULTADD/rtl_to_g1_withoutovf.log -replace
...
elaborate design -golden -root ALT_MULTADD -rootonly

read design -verilog -revised -lastmod -noelab \
	-unzip fv/ALT_MULTADD/g1.v.gz

elaborate design -revised -root ALT_MULTADD
...
uniquify -all -nolib
add module attribute ALT_MULTADD -pipeline_retime -golden
add module attribute ALT_MULTADD -pipeline_retime -revised
add noblack box ALT_MULTADD -submodules -golden
add noblack box ALT_MULTADD -submodules -revised
...
write hier_compare dofile fv/ALT_MULTADD/hier_rtl_to_g1_withoutovf.do \
...
run hier_compare fv/ALT_MULTADD/hier_rtl_to_g1_withoutovf.do -analyze_abort  -dynamic_hierarchy
