...
#  Created by Encounter(R) RTL Compiler v12.10-s012_1 on Fri Oct 23 18:02:29 -0500 2015
...
set_load -pin_load -max 0.02 [get_ports {oR[16]}]
set_load -pin_load -max 0.02 [get_ports {oR[15]}]
set_load -pin_load -max 0.02 [get_ports {oR[14]}]
set_load -pin_load -max 0.02 [get_ports {oR[13]}]
set_load -pin_load -max 0.02 [get_ports {oR[12]}]
set_load -pin_load -max 0.02 [get_ports {oR[11]}]
set_load -pin_load -max 0.02 [get_ports {oR[10]}]
set_load -pin_load -max 0.02 [get_ports {oR[9]}]
set_load -pin_load -max 0.02 [get_ports {oR[8]}]
set_load -pin_load -max 0.02 [get_ports {oR[7]}]
set_load -pin_load -max 0.02 [get_ports {oR[6]}]
set_load -pin_load -max 0.02 [get_ports {oR[5]}]
set_load -pin_load -max 0.02 [get_ports {oR[4]}]
set_load -pin_load -max 0.02 [get_ports {oR[3]}]
set_load -pin_load -max 0.02 [get_ports {oR[2]}]
set_load -pin_load -max 0.02 [get_ports {oR[1]}]
set_load -pin_load -max 0.02 [get_ports {oR[0]}]
