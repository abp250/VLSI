...
#  Created by Encounter(R) RTL Compiler v12.10-s012_1 on Fri Oct 23 17:57:03 -0500 2015
...
set_clock_transition -rise -min 1.0 [get_clocks clk]
set_clock_transition -rise -max 1.1 [get_clocks clk]
set_clock_transition -fall -min 1.1 [get_clocks clk]
set_clock_transition -fall -max 1.2 [get_clocks clk]
