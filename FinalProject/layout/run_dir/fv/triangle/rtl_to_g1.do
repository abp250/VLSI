...
usage -auto
set log file fv/triangle/rtl_to_g1.log -replace
// tclmode
...
vpx read guide file fv/triangle/rtl_to_g1.ovf
...
read library -statetable -liberty -pg_pin \
	/home/abp250/Documents/EE465/FinalProject/layout/run_dir/../encounter/libdir/lib/tcbn65gpluswc.lib \
	-both
...
set root module triangle -golden
read design -verilog \
	-unzip fv/triangle/g1.v.gz \
	-revised -lastmod
set root module triangle -revised
report design data
report black box
...
write hier_compare dofile fv/triangle/hier_rtl_to_g1.do \
...
run hier_compare fv/triangle/hier_rtl_to_g1.do
usage
