...
elaborate design -golden -root triangle -rootonly

read design -verilog -revised -lastmod -noelab \
	-unzip fv/triangle/g1.v.gz

elaborate design -revised -root triangle
...
run hier_compare fv/triangle/hier_rtl_to_g1.do -analyze_abort  -dynamic_hierarchy
